...
class CharacterHandler
{
    ...
    public:
        ...
        void HandlePlayerBotLoginCallback(QueryResult_AutoPtr /*dummy*/, SqlQueryHolder *holder)
        {
            if(!holder) return;
            ...
            {
                error_log("Excessively verbose Playerbot error checkpoint #1 hit. Please report this error immediately.");
            ...
            {
                error_log("Excessively verbose Playerbot error checkpoint #2 hit. Please report this error immediately.");
                if(holder) delete holder;
                return;
            }
            ...
            {
                error_log("Excessively verbose Playerbot error checkpoint #3 hit. Please report this error immediately.");
                if(holder) delete holder;
            ...
            {
                error_log("Excessively verbose Playerbot error checkpoint #4 hit. Please report this error immediately.");
                if(holder) delete holder;
                if(botSession) delete botSession;
                return;
            }
            ...
            {
                error_log("Excessively verbose Playerbot error checkpoint #5 hit. Please report this error immediately.");
                if(holder) delete holder;
                if(botSession) delete botSession;
                return;
            }
...
void WorldSession::AddPlayerBot(uint64 playerGuid)
{
    ...
    CharacterDatabase.DelayQueryHolder(&chrHandler,
        &CharacterHandler::HandlePlayerBotLoginCallback, holder);
