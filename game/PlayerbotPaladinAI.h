...
class PlayerbotPaladinAI : PlayerbotClassAI 
{
    ...
    private:
        ...
        //Damages
        uint32 JOL, JOW, HAMMER_OF_WRATH, EXORCISM, HOLY_WRATH, CONSECRATION, AVENGERS_SHIELD, SHIELD_OF_RIGHTEOUSNESS, HOTR, CRUSADER_STRIKE, DIVINE_STORM; 

        //CC
        uint32 HAMMER_OF_JUSTICE, REPENTANCE;
            
        //Self buffs
        uint32 SOL, SOW, SOR, SOC, DIVINE_PLEA, HOLY_SHIELD, RIGHTEOUS_FURY, DIVINE_SHIELD, AVENGING_WRATH;
