...
struct shaman_bot : public bot_ai
{
    shaman_bot(Creature *c) : bot_ai(c)
    {
        Reset();
    }
...
CreatureAI *GetAI_shaman_bot(Creature *pCreature)
{
    return new shaman_bot(pCreature);
}


void AddSC_shaman_bot()
{
    outstring_log("shamanBot added");
    Script *newscript;
    newscript = new Script;
    newscript->Name = "shaman_bot";
    newscript->GetAI = GetAI_shaman_bot;
