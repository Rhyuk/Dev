...
struct warlock_bot : public bot_ai
{
    warlock_bot(Creature *c) :bot_ai(c)
    {
        Reset();
        pet = NULL;
    }
...
CreatureAI *GetAI_warlock_bot(Creature *pCreature)
{
    return new warlock_bot(pCreature);
}

void AddSC_warlock_bot()
{
    outstring_log("warlockBot added.");
    Script *newscript;
    newscript = new Script;
    newscript->Name = "warlock_bot";
    newscript->GetAI = GetAI_warlock_bot;
