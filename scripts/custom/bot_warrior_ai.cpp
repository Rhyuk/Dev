...
struct warrior_bot : public bot_ai
{
    warrior_bot(Creature *c) : bot_ai(c)
    {
        Reset();
    }
...
CreatureAI *GetAI_warrior_bot(Creature *pCreature)
{
    return new warrior_bot(pCreature);
}

void AddSC_warrior_bot()
{
    outstring_log("warriorBot by paytheo added");
    Script *newscript;
    newscript = new Script;
    newscript->Name = "warrior_bot";
    newscript->GetAI = GetAI_warrior_bot;
